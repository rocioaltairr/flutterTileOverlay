...
//對齁 我可以把png檔名取成x+y.png 這樣就只需要在yaml 設定zoom檔了
...
class TileOverlayBodyState extends State<TileOverlayBody> {
  ...
  //final tileProvider = _DebugTileProvider();
  ...
  // void _updateText(CameraPosition position) {
  //   setState(() {
  //     str_zoom = position.zoom.toString();
  //     //str_zoom = (tileProvider.currentZoom).toString();
  //   });
  // }
    ...
    return Scaffold(
      body: Center(
        ...
        children: <Widget>[
          ...
          Center(
            child: Text('current zoom : $str_zoom'),
          ),
          TextButton(
